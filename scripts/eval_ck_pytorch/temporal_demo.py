...
def save_fig(pred,clip_path):
    ...
    plt.bar(x[1:], pred[1:])
    plt.savefig('/home/wxc/.pyenv/versions/3.5.5/envs/two_stream/flow/{}.jpg'.format(fig_name))
    plt.clf()


def main():

    model_path = '../../checkpoints/flow_model_best.pth.tar'
    data_dir = "~/basedata/expression_data/flow"
    start_frame = 0
    num_categories = 8
    ...
    val_file = "/home/wxc/.pyenv/versions/3.5.5/envs/two_stream/datasets/settings/ck/val_flow_split.txt"
